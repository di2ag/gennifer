...
from .tasks import create_sincerities_task
...
# Initialise environment variables
    ...
    requests_cache.install_cache('sincerities_cache')
    ...
    class RunAlgorithm(Resource):
        ...
        def post(self):
            ...
            task = create_sincerities_task.delay(args["zenodo_id"], nBins)
    ...
    class AlgorithmInfo(Resource):
        ...
        def get(self):
            ...
            info = {
                    "name": 'sincerities',
                    "description": 'The current implementation of SINCERITIES takes an expression matrix and a list of genes as input. It produces a ranked list of edges as output, which we used directly in our analysis.',
                    "edge_weight_type": '',
