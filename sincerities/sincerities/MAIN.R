...
print(args)
# *** Data loading ***
uploading <- dget("sincerities/SINCERITIES functions/uploading.R")
DATA <- uploading(args[1])

# *** SINCERITIES ***

SINCERITITES <- dget("sincerities/SINCERITIES functions/SINCERITIES.R")
...
final_ranked_predictions <- dget("sincerities/SINCERITIES functions/final_ranked_predictions.R")
