...
from .tasks import create_leap_task
...
# Initialise environment variables
    ...
    requests_cache.install_cache('leap_cache')
    ...
    class RunAlgorithm(Resource):
        ...
        def post(self):
            ...
            task = create_leap_task.delay(args["zenodo_id"], maxLag)
    ...
    class AlgorithmInfo(Resource):
        ...
        def get(self):
            ...
            info = {
                    "name": 'leap',
                    "description": 'The current implementation of LEAP takes an expression matrix and a list of genes as input. It produces a ranked list of edges as output, which we used directly in our analysis.',
                    "edge_weight_type": '',
